...
V = ngme2::rig(n, a = eta, b = h_nig_1d^2*eta, sample.int(10^6, 1))
...
V_1 <- matrix(ngme2::rig(10, eta, eta*h_nig_1d^2), nrow=1)
V_2 <- matrix(ngme2::rig(10, eta, eta*h_nig_1d^2), nrow=1)
```
