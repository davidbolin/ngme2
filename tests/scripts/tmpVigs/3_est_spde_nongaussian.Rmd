...
n_gibbs_samples <- function(kappa_sq, N_sim, V_init, W_init){
  V <- V_init
...
list_VW <- n_gibbs_samples(kappa_est, 300, V_init, W_init)
...
while(tol > epsilon){
  ...
  list_VW <- n_gibbs_samples(kappa_est, gibbs_nsim, V_init, W_init)
  V_matrix <- list_VW[["V"]]
  W_matrix <- list_VW[["W"]]
