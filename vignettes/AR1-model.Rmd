...
traceplot2(ngme_out, param = "sigma", f_index = 0)

# traceplots of the AR(1) model
traceplot2(ngme_out, param = "alpha", f_index = 1)
traceplot2(ngme_out, param = "mu", f_index = 1)
traceplot2(ngme_out, param = "sigma", f_index = 1)
