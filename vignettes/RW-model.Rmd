...
rw1_unconstrained <- f(locations, model = "rw1", constr = FALSE,
                       noise = noise_normal(sigma = 1.0))
rw2_unconstrained <- f(locations, model = "rw2", constr = FALSE,
...
rw1_cyclic <- f(locations, model = "rw1", cyclic = TRUE,
                noise = noise_normal(sigma = 1.0))
rw2_cyclic <- f(locations, model = "rw2", cyclic = TRUE,
                noise = noise_normal(sigma = 0.5))
```
...
for(i in 1:3) {
  ...
  p <- ggplot() +
    ...
    labs(title = paste(gap$name, "- RW1 Interpolation"), 
         x = "Time", y = "Value") +
    theme_minimal() +
