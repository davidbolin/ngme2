...
theta = pi/8; rho = 3; rho_1 = 0.6; rho_2 = 0.4
...
### Ex3. Fixed effects + Bivariate model (Matérn, NIG) + Correlated measurement noise
...
theta = pi/8; rho = 1; theta_K_1 = log(1); theta_K_2 = log(5);
mu_1 = -2; sigma_1 = 1; nu_1 = 1
mu_2 = 2; sigma_2 = 2; nu_2 = 0.5
...
true_model <- f(
  ...
  group = group,
  noise = list(W1 = noise_nig(
    mu = mu_1, sigma = sigma_1, nu=nu_1
  ), W2 = noise_nig(
    mu = mu_2, sigma = sigma_2, nu=nu_2
  ))
)
