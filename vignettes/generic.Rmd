...
- The precision matrix is constructed as D_alpha * A + B, where D_alpha is a diagonal matrix
...
- The first term multiplies parameter matrix 1 with fixed matrix 1 (indices 1 and 2)
- The second term is just fixed matrix 2 (index 3)
