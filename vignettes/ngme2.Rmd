...
The package `ngme2` provides methods for mixed effect models both for single response variable case and bivariate response model (see bivariate model vignette for details).

It follows the general structure of the mixed effect model:
$$
\begin{aligned}
...
out <- ngme(
  formula = Y ~ 1 +
    f(inla.group(seaDist), name="rw1", model = "rw1", noise = noise_normal()) +
