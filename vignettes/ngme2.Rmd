...
knitr::kable(cv$mean.scores, 
             caption = "Cross-validation results") %>%
  kableExtra::kable_styling() %>%
  kableExtra::row_spec(which.min(cv$mean.scores$RMSE), 
                       color = "red", 
                       bold = TRUE) %>%
  kableExtra::row_spec(which.min(cv$mean.scores$MAE), 
                       color = "red", 
                       bold = TRUE) %>%
  kableExtra::row_spec(which.min(cv$mean.scores$CRPS), 
                       color = "red", 
                       bold = TRUE) %>%
  kableExtra::row_spec(which.min(cv$mean.scores$DSS), 
                       color = "red", 
                       bold = TRUE)
```
