...
plot(
  ngme_out$replicates[[1]]$latents[[1]]$noise,
...
res1 <- data.frame(
  intercept    = format(out$replicates[[1]]$beta, digits=3),
  ...
  noise_nu     = format(out$replicates[[1]]$noise$nu, digits=3),
  rw_sigma     = format(out$replicates[[1]]$latents[[1]]$noise$theta_sigma, digits=3),
  ma_kappa     = format(exp(out$replicates[[1]]$latents[[2]]$theta_K), digits=3),
  ma_sigma     = format(exp(out$replicates[[1]]$latents[[2]]$noise$theta_sigma), digits=3)
)
