...
# Apply styling with kableExtra
cv_table <- kableExtra::kable_styling(cv_table)

# Highlight the rows with minimum values for each metric
cv_table <- kableExtra::row_spec(cv_table, which.min(cv$mean.scores$RMSE), 
                       color = "red", 
                       bold = TRUE)
cv_table <- kableExtra::row_spec(cv_table, which.min(cv$mean.scores$MAE), 
                       color = "red", 
                       bold = TRUE)
cv_table <- kableExtra::row_spec(cv_table, which.min(cv$mean.scores$CRPS), 
                       color = "red", 
                       bold = TRUE)
cv_table <- kableExtra::row_spec(cv_table, which.min(cv$mean.scores$DSS), 
                       color = "red", 
                       bold = TRUE)
