...
true_sigma <- 4
true_nu <- 20
true_noise <- noise_nig(mu = true_mu, sigma = true_sigma, nu = true_nu)
...
model_nonsep
traceplot(model_nonsep)
traceplot(model_nonsep, "advection_field", hline = c(
  true_cc,
  true_kappa,
  true_theta_gamma_x,
  true_theta_gamma_y,
  true_mu, true_sigma, true_nu
))
```
