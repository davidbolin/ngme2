...
p1 <- ggplot(gaussian_data, aes(x = time, y = value)) +
  ...
  labs(
    ...
    subtitle = paste("theta =", theta_sim, ", sigma =", sigma_sim),
    x = "Time",
    y = "Value"
  ) +
  theme_minimal() +
...
p3 <- ggplot(nig_data, aes(x = time, y = value)) +
  ...
  labs(
    ...
    subtitle = paste(
      "theta =", theta_sim, ", sigma =", sigma_sim,
      ", NIG innovations: mu=-3, sigma=4, nu=0.4"
    ),
    x = "Time",
    y = "Value"
  ) +
...
p_theta_comparison <- ggplot(
  ...
  labs(
    ...
    subtitle = paste("All centered at zero with sigma =", sigma_sim),
    x = "Time",
    y = "Value",
