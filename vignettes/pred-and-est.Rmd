...
temp <- data.frame(
  acf = as.vector(acf(V_2[, 1], plot = FALSE)$acf),
...
df_pred <- data.frame(
  idx = 1:length(AW_1), MC = MC_pred_1,
...
temp <- data.frame(
  idx = 1:length(AW_2), MC = MC_pred_2,
