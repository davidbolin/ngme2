---
title: "Gibbs sampling, model predictoin and estimation"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Gibbs sampling and model predictoin}
...
V_1 <- matrix(ngme2::rig(10, eta, eta*h_nig_1d^2, seed = 1), nrow = 1)
V_2 <- matrix(ngme2::rig(10, eta, eta*h_nig_1d^2, seed = 2), nrow = 1)
```
