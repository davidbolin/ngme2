...
$$ Y_i = x(\mathbf{s}_i) + \varepsilon_i, \quad i=1,\ldots,N, \quad \epsilon_i\sim N(0, \sigma^2),$$
...
V = ngme2::rig(n, a = rep(0.5,n), b = h_nig_1d^2*0.5, sample.int(10^6, 1))
...
V_2d = ngme2::rig(n_2d, a = rep(0.5,n_2d), b = h_2d_samp^2*0.5, seed  = sample.int(10^6, 1))
